...
#import define msg
from hawkbotcar_msgs.msg import PointArray
#import commom lib
import cv2 as cv
import numpy as np
import time
...
class FaceEyeDetection(Node):
    def __init__(self,name):
        ...
        self.eyeDetect = cv.CascadeClassifier( "/home/hawkbot/ROS2_WS/src/hawkbot_mediapipe/hawkbot_mediapipe/file/haarcascade_eye.xml")
        self.faceDetect = cv.CascadeClassifier("/home/hawkbot/ROS2_WS/src/hawkbot_mediapipe/hawkbot_mediapipe/file/haarcascade_eye.xml")
...
class MY_Picture(Node):
    def __init__(self, name):
        ...
        self.sub_img = self.create_subscription(
            CompressedImage, '/image_raw/compressed', self.handleTopic, 1) #获取esp32传来的图像
